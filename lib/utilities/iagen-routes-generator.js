...
function addIagenRoutes(routerFile, options) {
...
module.exports.addIagenRoutes = addIagenRoutes;


function removeIagenRoutes(routerFile, options) {
  var fileContent = fs.readFileSync(routerFile, 'utf8');
  var routes = new EmberRouterGenerator(fileContent);
  var newFileContent = routes
...
module.exports.removeIagenRoutes = removeIagenRoutes;
